...
{
	print("\n--------------------------------------");
	print(" Camera Position setup v1.0 by Ikey07 && Edit by Letruta");
	print("--------------------------------------\n");
	return 1;
}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
    ...
    if(strcmp(cmd, "/cam", true) == 0)
	{
		...
		{
		    SendClientMessage(playerid, 0xFF4B4BFF, "Você precisa ser admin para usar este comando");
		    return 1;
		}
	}
